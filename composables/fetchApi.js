...
const get = async (url, opts = {},host = null) => await useFetch(url, { method: "GET", ...opts, ...init(host)})
const post = async (url, opts = {},host = null) => await useFetch(url, { method: "POST", ...opts, ...init(host) })
const put = async (url, opts = {},host = null) => await useFetch(url, { method: "PUT", ...opts, ...init(host) })

const init = (host) => {
    const config = useRuntimeConfig()
    const baseURL = host ?? config.public.baseURL
    return {
        baseURL: baseURL,
        headers: {
