export default {
  ...
  Product: {
    getAll: "admin/Product/paged",
    getById: (id) => `admin/Product/${id}`,
    add: 'admin/Product',
    edit: 'admin/Product',
    delete: (id) => `admin/Product/${id}`,
  },
  Article: {
    get: {
      byId: "admin/Content/",
  ...
  Comment: {
    ...
    publishComment: 'admin/comment/publishing',
  },
  Discount: {
    get: {
  ...
  tag:{
    getAll: 'admin/Tag/paged',
    add: 'admin/Tag',
    edit: 'admin/Tag',
    delete: (id) => `admin/Tag/${id}`,
  },
  //#endregion
  ...
  public: {
    ...
    Comment: {
      ...
      add_product_comment: "public/Comment/add-product-comment",
    },
    Score: {
    ...
    Product:{
      getAll: "Product/paged",
      getById: (id) => `Product/${id}`,
      like: (id) => `Product/${id}/like`,
      disLike: (id) => `Product/${id}/dislike`,
      addScore: "Product/score",
    },
  },
  //#endregion
  ...
  storeServices:{
    storeBasket:{
      get:{
        getSoldStoreProductsByStatus: (Status) => `seller/storeBasket?storeBasketStatus=${Status}`,
        getSoldStoreProductsById: (id) => `seller/storeBasket/${id}`,
      },
      put:{
        changeBasketStatus: "seller/StoreBasket",
      }
    },
    comments:{
      post:{
        getAll: "comments/list",
        addComment: "comments/add-store-product-comment",
      }
    },
    store:{
      get:{
        userGetStore: "seller/store",
        getStoreById: (id) => `stores/${id}`,
      },
      post:{
        getAllStores: "stores/paged",
        userAddStore: "seller/store",
        addScore: "stores/score",
      },
      put:{
        userUpdateStore: "seller/store",
      }
    },
    product:{
      get:{
        userGetAllProdcutsByCatId: (catId) => `seller/product/list/${catId}`,
        getProductById: (id) => `Product/${id}`,
      },
      post:{
        getAllProducts: "product/paged",
      },
    },
    categories:{
      get:{
        getAllFlat: "categories/flat",
        getAllTree: "categories",
        getAll: (id) => `categories/full/${id}`
      },
      post:{
        getAllByStoreId: "categories",
      },
    },
    attributes:{
      get:{
        getAttributesByCatId: (id) => `seller/attributes/${id}`,
      },
    },
    storeProducts:{
      get:{
        getById: (id)=> `store-products/${id}`,
      },
      sellerGet: (id) => `seller/store-products/${id}`,
      post: {
        addNewProduct: 'seller/store-products',
        getAllProducts: "store-products/paged",
        usergetAllProducts: "seller/store-products/paged",
        addScore: "/store-products/score",
      },
      put: 'seller/store-products/',
      delete:{
        deleteById: (id) => `seller/store-products/${id}`
      },
    },
    tags:{
      get: {
        getTagsByCatId: (id) => `seller/tags/${id}`
      }
    },
    baskets:{
      get:{
        getBasketById: (id) => `user/baskets/${id}`,
        getCurrentBasket: 'user/baskets/current'
      },
      post:{
        getAllBaskets: "user/baskets/paged",
        addNewProduct: 'user/baskets/add-item',
        completeBasket: 'user/baskets/complete',
      },
      delete:{
        deleteItemById: (id) => `user/baskets/item/${id}`,
      },
    },
    payment:{
      post:{
        payCurrentBasket: "user/payments/pay-current-basket",
      }
    },
  },
  //#endregion
