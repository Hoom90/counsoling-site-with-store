...
<template>  
  ...
  <v-table>
      <thead>
        <tr>
          ...
          <th class="text-center">
            <v-btn variant="text" prepend-icon="mdi-magnify" @click="state.expertFilterModal = !state.expertFilterModal">متخصص</v-btn>
          </th>
  ...
  <mj-dialog v-model="state.expertFilterModal" :title="`جستجو براساس نام متخصص`" :action-btn="true" action-btn-text="فیلتر کردن" :cancel-btn="true" action-type="primary"
