...
<template>
      ...
      <thead>
        <tr>
          ...
          <th class="text-center">
            <v-btn variant="text" prepend-icon="mdi-magnify" @click="state.modal = !state.modal">متخصص</v-btn>
          </th>
  ...
  <mj-dialog v-model="state.modal" :title="`جستجو براساس نام متخصص`" :action-btn="true" action-btn-text="فیلتر کردن" :cancel-btn="true" action-type="primary"
