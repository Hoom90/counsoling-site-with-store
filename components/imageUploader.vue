...
<template>
  <div class="text-center ma-4">
    <label style="cursor: pointer">
      <BaseImage :src="props.modelValue" :path="state.imageFile" :no-image="noimage" :customClass="`mx-auto mb-3 ${props.customeClass}`"></BaseImage>
      <input type="file" class="d-none" @change="fileUploadSelect" accept="image/png, image/gif, image/jpeg"
        v-if="!state.uploadImage">
      <v-alert border="start" border-color="deep-purple accent-4" elevation="2" class="mx-auto pa-2 cursor-pointer" width="155px">
