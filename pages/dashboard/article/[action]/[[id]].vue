        ...
        <v-card>
          <v-card-text>
            ...
            <v-textarea v-model="state.formData.summary" variant="outlined" label="چکیده مقاله*"
             :rules="validator.content.summery" rows="5"></v-textarea>

            <BaseTiptap v-if="state.loadEditor" ref="verfyTiptap" v-model="state.formData.body" label="متن اصلی مقاله*" rules="مقدار وارد شده اشتباه است"/>
